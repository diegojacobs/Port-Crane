...
OIMO.World.prototype = {
        ...
        checkContact: function(name1, name2) {
            ...
            while (contact !== null) {
                ...
                if ((n1 == name1 && n2 == name2) || (n2 == name1 && n1 == name2)) { if (contact.touching) return true;
                    else return false; } else contact = contact.next;
            }
            return false;
    ...
    updatePosition: function(timeStep) {
        switch (this.type) {
            ...
            case OIMO.BODY_DYNAMIC:
                ...
                break;
            default:
                OIMO.Error("RigidBody", "Invalid type.");
        }
...
OIMO.Performance.prototype = {
    upfps: function() {
        this.f[1] = Date.now();
        if (this.f[1] - 1000 > this.f[0]) { this.f[0] = this.f[1];
            this.fps = this.f[2];
            this.f[2] = 0; }
        this.f[2]++;
    },
...
OIMO.Euler.prototype = {
    ...
    _y: 0,
    _z: 0,
    _order: OIMO.Euler.DefaultOrder,
...
OIMO.HingeJoint = function(config, lowerAngleLimit, upperAngleLimit) {
    ...
    this.localAngle1 = new OIMO.Vec3(
        this.localAxis1.y * this.localAxis1.x - this.localAxis1.z * this.localAxis1.z, -this.localAxis1.z * this.localAxis1.y - this.localAxis1.x * this.localAxis1.x,
...
OIMO.HingeJoint.prototype.preSolve = function(timeStep, invTimeStep) {
    ...
    this.tan.set(
        this.nor.y * this.nor.x - this.nor.z * this.nor.z, -this.nor.z * this.nor.y - this.nor.x * this.nor.x,
...
OIMO.World.prototype.add = function(obj) {
    ...
    if (type[0].substring(0, 5) == 'joint') { // is joint
        ...
        for (var i = 0; i < type.length; i++) {
            ...
            switch (type[i]) {
                case "sphere":
                    shapes[i] = new OIMO.SphereShape(sc, s[n]);
                    break;
                case "cylinder":
                    shapes[i] = new OIMO.CylinderShape(sc, s[n], s[n + 1]);
                    break;
                case "box":
                    shapes[i] = new OIMO.BoxShape(sc, s[n], s[n + 1], s[n + 2]);
                    break;
            }
